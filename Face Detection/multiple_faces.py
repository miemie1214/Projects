...
def yf2473_Yiyang_kmeans(imgPath, imgFilename, savedImgPath, savedImgFilename, k):
    ...
    # threshold image
    ret, threshed_img = cv2.threshold(result, 1, 2, cv2.THRESH_BINARY)
    ...
    for c in contours:
        ...
        if w < 100 and w > 50 and h > 10 and h < 100:
...
if __name__ == "__main__":
    imgPath = "/Users/Anne/Desktop/5293HW1"
    imgFilename = "faces.jpg"
    savedImgPath = r'/Users/Anne/Desktop/5293HW1'
    savedImgFilename = "face_d4_face.jpg"
    k = 3
